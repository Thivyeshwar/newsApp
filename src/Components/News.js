...
const News=(props)=> {
  ...
  // async componentDidMount(){
    ...
    // let url= `https://newsapi.org/v2/top-headlines?country=${ props.country}&category=${ props.category}&apiKey=91c9cca295d84677abe11dbbf1597829&page=1&pageSize=${ props.pageSize}`;
